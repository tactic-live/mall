...
public class SmsHomeNewProductServiceImpl implements SmsHomeNewProductService {
	...
	@Override
	public List<SmsHomeNewProduct> create(List<SmsHomeNewProduct> homeNewProductList) {
		...
		for (SmsHomeNewProduct SmsHomeNewProduct : homeNewProductList) {
			...
			productIdList.add(SmsHomeNewProduct.getProductId());
		}
//        return homeNewProductList.size();
		return homeNewProductMapper.selectByProductIdList(productIdList);
	}
...
//        example.setOrderByClause("sort desc");
		return homeNewProductMapper.selectByExample(productName, recommendStatus);
	}
}
