...
import com.macro.mall.dto.SmsAdvertiseStatusParam;
...
//    }
    ...
    @ResponseBody
    public CommonResult updateStatus(@RequestBody SmsAdvertiseStatusParam smsAdvertiseStatusParam) {
        int count = advertiseService.updateStatus(smsAdvertiseStatusParam.getId(), smsAdvertiseStatusParam.getStatus());
        if (count > 0)
            return CommonResult.success(count);
        return CommonResult.failed();
    }
