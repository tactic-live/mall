...
public interface SmsHomeBrandMapper {
	...
	//	List<SmsHomeBrand> selectByExample(SmsHomeBrandExample example, @Param("recommendStatus") Integer recommendStatus);
	List<SmsHomeBrand> selectByExample(@Param("brandName") String brandName, @Param("recommendStatus") Integer recommendStatus);
	...
	List<SmsHomeBrand> selectByBrandIdList(@Param("brandIdList") List<Long> brandIdList);
}